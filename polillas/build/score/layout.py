...
breaks = evans.Breaks(
    ...
    evans.Page(
        ...
        evans.System(measures=15, lbsd=(130, "(19 20 20 20)"), x_offset=1),
        evans.System(measures=8, lbsd=(240, "(19 20 20 20)"), x_offset=1),
    ),
    evans.Page(
        evans.System(measures=6, lbsd=(20, "(19 20 20 20)"), x_offset=1),
        evans.System(measures=6, lbsd=(130, "(19 20 20 20)"), x_offset=1),
        evans.System(measures=6, lbsd=(240, "(19 20 20 20)"), x_offset=1),
    ),
    evans.Page(
        evans.System(measures=6, lbsd=(20, "(19 20 20 20)"), x_offset=1),
        evans.System(measures=14, lbsd=(130, "(19 20 20 20)"), x_offset=1),
        evans.System(measures=12, lbsd=(240, "(19 20 20 20)"), x_offset=1),
    ),
    evans.Page(
    ...
    evans.Page(
        ...
        evans.System(measures=8, lbsd=(130, "(19 20 20 20)"), x_offset=1),
        evans.System(measures=9, lbsd=(240, "(19 20 20 20)"), x_offset=1),
    ),
    evans.Page(
        evans.System(measures=14, lbsd=(20, "(19 20 20 20)"), x_offset=1),
        evans.System(measures=10, lbsd=(130, "(19 20 20 20)"), x_offset=1),
        evans.System(measures=13, lbsd=(240, "(19 20 20 20)"), x_offset=1),
    ),
    evans.Page(
        evans.System(measures=7, lbsd=(20, "(19 20 20 20)"), x_offset=1),
        evans.System(measures=7, lbsd=(130, "(19 20 20 20)"), x_offset=1),
    ...
    evans.Page(
        evans.System(measures=10, lbsd=(20, "(19 20 20 20)"), x_offset=1),
        evans.System(measures=9, lbsd=(130, "(19 20 20 20)"), x_offset=1),
        evans.System(measures=7, lbsd=(240, "(19 20 20 20)"), x_offset=1),
    ),
    evans.Page(

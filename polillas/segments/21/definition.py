...
maker = evans.SegmentMaker(
    ...
    commands=[
        ...
        evans.attach(  # parts
            ...
            lambda _: abjad.Selection(_).leaves().group_by_measure().get([19]).leaf(0),
            direction=abjad.UP,
        ),
        evans.attach(  # parts
            "violin 2 voice",
        ...
        evans.attach(  # parts
            "violin 1 voice",
            abjad.Markup(
                r"""\rehearsal-mark-markup "x3" 3 1.5""",
            ),
            polillas.select_measures([11], leaf=0),
            direction=abjad.UP,
        ),
        evans.attach(  # parts
            "violin 2 voice",
        ...
        evans.attach(  # parts
            "violin 1 voice",
            polillas.mark_90,
            polillas.select_measures([20], leaf=0),
        ),
        evans.attach(  # parts
            "violin 2 voice",
            polillas.mark_90,
        ...
        evans.attach(  # parts
            "violin 1 voice",
            polillas.mark_40,
            polillas.select_measures([29], leaf=0),
        ),
        evans.attach(  # parts
            "violin 2 voice",
            polillas.mark_40,
        ...
        evans.attach(  # parts
            "violin 1 voice",
            polillas.met_mod_40_66,
            polillas.select_measures([32], leaf=0),
        ),
        evans.attach(  # parts
            "violin 2 voice",
            polillas.met_mod_40_66,

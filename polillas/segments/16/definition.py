...
maker = evans.SegmentMaker(
    ...
    commands=[
        ...
        evans.call(
            "violin 1 voice",
            abjad.trill_spanner,
            polillas.select_measures([0], leaves=[0, 1]),
        ),
        evans.call(
            "violin 1 voice",
            abjad.trill_spanner,
            polillas.select_measures([0, 1], leaves=[2, 3]),
        ),
        evans.call(
            "violin 1 voice",
            abjad.trill_spanner,
            polillas.select_measures([4, 5, 6], leaves=[0, 1]),
        ),
        evans.call(
            "violin 1 voice",
            abjad.trill_spanner,
            polillas.select_measures([4, 5, 6], leaves=[2, 3]),
        ),
        evans.call(
            "violin 1 voice",
            abjad.trill_spanner,
            polillas.select_measures([9, 10, 11, 12], leaves=[0, 1]),
        ),
        evans.call(
            "violin 1 voice",
            abjad.trill_spanner,
            polillas.select_measures([9, 10, 11, 12], leaves=[2, 3, 4, 5, 6]),
        ),
        evans.call(
            "violin 1 voice",
            abjad.trill_spanner,
